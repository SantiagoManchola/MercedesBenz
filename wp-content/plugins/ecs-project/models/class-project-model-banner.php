...
class Project_Model_Banner
{
    ...
    function __construct($template_parser)
    {
        ...
        $this->post_type_singular = __('Banner Home', 'enigmind');
        $this->post_type_plural = __('Banners Home', 'enigmind');
        $this->request_type_taxonomy = 'artCategory';
        $this->request_type_taxonomy_singular = __('Categoria', 'enigmind');
        $this->request_type_taxonomy_plural = __('Categorias', 'enigmind');
        $this->request_type_taxonomy2 = 'artType';
        $this->request_type_taxonomy_singular2 = __('Tipo', 'enigmind');
        $this->request_type_taxonomy_plural2 = __('Tipos', 'enigmind');
    ...
    function metabox_general()
    {
        ...
        $cmb->add_field(array(
            'name'    => 'Imagen Banner Home',
            'desc'    => 'Actualizar imagen del banner',
            'id'      => 'banner_home',
            'type'    => 'file'
        ));
        $cmb->add_field(array(
            'name'    => 'Mensaje',
            'desc'    => 'Mensaje del Botón',
            'default' => '',
            'id'      => $prefix . 'button_message',
            'type'    => 'text'
        ));
    }
